...
import { MagnifyingGlassIcon, ChevronUpDownIcon, TrashIcon, UserPlusIcon, PencilIcon } from "@heroicons/react/24/solid";
import { Dialog, Transition } from '@headlessui/react';
import { Card, CardHeader, Typography, Button, CardBody, CardFooter, IconButton, Tooltip, Input, Menu, MenuHandler, MenuList, MenuItem } from "@material-tailwind/react";
                                        ...
                                        <Dialog.Panel className="w-full max-w-4xl transform  rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                            ...
                                            <div className="mt-2">
                                                ...
                                                <div className="mt-4 grid grid-cols-2 gap-4">
                                                    <RolesList value={userData.roles}
