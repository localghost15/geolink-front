...
import ReAdmissionsList from './components/ReAdmissionsList';
  ...
  export default function ReAdmissions() {
    return (
      <Card className="h-full w-full rounded-none pt-5">
           

        <Typography className="mx-8 mb-2" variant="h3" color="black">Қайта қабуллар</Typography>
    ...
    <Button size="md" ><MagnifyingGlassIcon className="h-5 w-5" /></Button>
        ...
        <CardBody className="overflow-scroll px-0">
          <table className="mt-4  w-full min-w-max table-auto text-left">
            ...
            <tbody>
              {TABLE_ROWS.map(
                ({ name, birth,phone, service, date}, index) => {
