              ...
              <div className="g-0 lg:flex lg:flex-wrap">
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    ...
                    <div className='mb-3'>
                  <svg className='w-16 '  viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div
                className="flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none login-bg">
